...
"""
    ...
    texts[
        "Tutorial3_icon"
    ] = """אחרי פרק זמן זה, יוצג שוב האיור ויושמעו סדרה של צלילים.
...
יש להאזין לסדרה השניה של הצלילים ולהחליט בדיוק ובמהירות האפשריים, האם הצלילים מהירים ({moreResp}) או אטיים ({lessResp}) 
מסדרת הצלילים השניה.

יש להאזין לסדרה השניה של הצלילים 
ולהחליט בדיוק ובמהירות האפשריים, 
האם הצלילים מהירים ({moreResp}) או אטיים ({lessResp}) מסדרת הצלילים השניה.


הצלילים בסדרה השניה תמיד יהיו מהירים או אטיים nמהסדרה הראשונה. במידה ולא בטוחים, צריך לנחש.
"""
    texts[
        "Tutorial4"
