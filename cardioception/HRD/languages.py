...
יש להאזין לסדרה השניה של הצלילים ולהחליט האם הצלילים מהירים ({moreResp}) או אטיים ({lessResp}) 
מסדרת הצלילים השניה.

הצלילים בסדרה השניה תמיד יהיו מהירים או אטיים מהסדרה הראשונה. במידה ולא בטוחים, צריך לנחש.
"""
    texts[
        "Tutorial4"
