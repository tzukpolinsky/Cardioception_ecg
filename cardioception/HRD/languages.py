...
def hebrew(device: str, setup: str, exteroception: bool) -> Dict[str, Collection[str]]:
    ...
    texts[
        "Tutorial1"
    ] = """בניסוי זה אנחנו נקליט את הלב שלך ונשמיע צלילים מהירים או אטיים מקצב פעימות הלב.
    המטרה שלך, היא להחליט האם הצלילים מהירים או איטיים מקצב הלב כפי שחשת אותו"""
    texts[
        "Tutorial2"
